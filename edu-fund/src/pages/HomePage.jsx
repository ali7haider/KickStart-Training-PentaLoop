  ...
  const features = [
    {
      id: 1,
      title: "Find Your Fit",
      description: "Browse a curated list of scholarships matching your profile and academic goals.",
      icon: "🔍" 
    },
    {
      id: 2,
      title: "Streamlined Process",
      description: "Our multi-step form makes applying quick and ensures you never miss a requirement.",
      icon: "⚡"
    },
    {
      id: 3,
      title: "Track Your Progress",
      description: "Save your applications and come back to them anytime before the deadline.",
      icon: "📊"
    }
  ];
